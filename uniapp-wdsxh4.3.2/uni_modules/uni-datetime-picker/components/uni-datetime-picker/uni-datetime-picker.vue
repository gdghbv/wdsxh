<template>
	<view class="uni-date" :style="{'--theme-color': themeColor}">
		...
		<view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
			<view v-if="!isRange" class="uni-date-single--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="uni-date-changed popup-x-header">
					...
					<time-picker type="time" v-model="pickerTime" :theme-color="themeColor" :border="false" :disabled="!inputDate" :start="timepickerStartTime" :end="timepickerEndTime" :hideSecond="hideSecond" style="width: 100%;">
						<input class="uni-date__input text-center" type="text" v-model="pickerTime" :placeholder="selectTimeText" :disabled="!inputDate" />
					</time-picker>
				</view>

				<Calendar ref="pcSingle" :theme-color="themeColor" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate" :date="calendarDate" @change="singleChange" :default-value="defaultValue" style="padding: 0 8px;" />
			...
			<view v-else class="uni-date-range--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="popup-x-header uni-date-changed">
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" v-model="tempRange.startTime" :theme-color="themeColor" :start="timepickerStartTime" :border="false" :disabled="!tempRange.startDate" :hideSecond="hideSecond">
					...
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" v-model="tempRange.endTime" :theme-color="themeColor" :end="timepickerEndTime" :border="false" :disabled="!tempRange.endDate" :hideSecond="hideSecond">
				...
				<view class="popup-x-body">
					<Calendar ref="left" :theme-color="themeColor" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate" :range="true" :pleStatus="endMultipleStatus" @change="leftChange" @firstEnterCale="updateRightCale" style="padding: 0 8px;" />
					<Calendar ref="right" :theme-color="themeColor" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate" :range="true" @change="rightChange" :pleStatus="startMultipleStatus" @firstEnterCale="updateLeftCale" style="padding: 0 8px;border-left: 1px solid #F1F1F1;" />
				</view>
		...
		<Calendar v-if="isPhone" ref="mobile" :theme-color="themeColor" :clearDate="false" :date="calendarDate" :defTime="mobileCalendarTime" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate" :selectableTimes="mobSelectableTime" :startPlaceholder="startPlaceholder" :endPlaceholder="endPlaceholder" :default-value="defaultValue" :pleStatus="endMultipleStatus" :showMonth="false" :range="isRange" :hasTime="hasTime" :insert="false" :hideSecond="hideSecond" @confirm="mobileChange" @maskClose="close" @change="calendarClick" />
	</view>
</template>
<script>
	/**
