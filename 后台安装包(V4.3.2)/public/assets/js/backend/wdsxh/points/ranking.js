            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'wechat_id', title: __('Wechat_id'), operate: 'LIKE' },
                        {
                            field: 'member.name', title: __('Name'), operate: 'LIKE', formatter: function (value, row) {
                                return row.name;
                            }
                        },
                        { field: 'member.mobile', title: __('Mobile'), operate: 'LIKE', formatter: function (value, row) { return row.mobile; } },

                        { field: 'level.name', title: __('Level.name'), operate: 'LIKE' },
                        { field: 'wechat.points', title: __('Points'), operate: false },
                        {field:'wechat.total_points', title: __('Total_points'), operate: false},
                        {
